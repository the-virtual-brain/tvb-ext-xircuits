...
export function inputDialog({ title, oldValue, type, inputType, attached, showAttachOption, possibleValues }: InputDialogueProps) {
...
export const LiteralInputDialog = ({ title, oldValue, type, inputType, attached, showAttachOption, possibleValues }): JSX.Element => {
